    ...
    return (
        ...
        >
            ...
            >
                ...
                <Modal.Body>
                    Версия приложения: 1.0.1. На данном этапе любой курсант может авторизовать под правами
                    администратора. Если кто-то захочет "повеселиться" - помните, что все действия записываются с точной
                    датой и временем. Последствия будут.
                </Modal.Body>
                <Modal.Footer>
